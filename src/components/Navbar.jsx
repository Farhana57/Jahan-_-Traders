...
export default function Navbar() {
  ...
  return (
    <>
      {/* =====================================================
         TOP BAR (গাঢ় সবুজ, ফোন, ইমেইল, এক্সপোর্ট ও সোশ্যাল আইকনসহ)
      ====================================================== */}
      ...
      <nav className="bg-white text-slate-800 sticky top-0 z-50 border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            >
              ...
              {dropdownOpen && (
                <div className="absolute top-full left-0 w-64 bg-white border border-slate-100 rounded-xl shadow-xl p-2 z-50">
                  <Link to="/products/jute-sacks" className="block px-4 py-2 hover:bg-emerald-100 rounded-lg">Jute Sacks & Bags</Link>
                  <Link to="/products/jute-yarn" className="block px-4 py-2 hover:bg-emerald-100 rounded-lg">Jute Yarn & Twine</Link>
                  <Link to="/products/geotextiles" className="block px-4 py-2 hover:bg-emerald-100 rounded-lg">Jute Geotextiles</Link>
                </div>
              )}
            </div>
          ...
          {/* CONTACT BUTTON */}
<Link to="/contact" className="relative hidden md:inline-block bg-emerald-700 text-white px-6 py-2.5 rounded-lg font-bold transition shadow-md overflow-hidden group">
  ...
  className="relative block bg-emerald-700 text-white text-center py-2.5 rounded-lg font-bold shadow overflow-hidden group"
>
  {/* Hover Slide Background */}
  <span className="absolute inset-0 bg-amber-500 transform -translate-y-full transition-transform duration-300 ease-in-out group-hover:translate-y-0"></span>
